 ...
 * <pre>
 ...
 10           19.210              {@link CustomExponentialBackOff#maxElapsedTimeMillis}
 * </pre>
 *
 * <p>
 ...
 * @author Ravi Mistry
 */
public class CustomExponentialBackOff {
    ...
    /**
     * The maximum elapsed time after instantiating {@link CustomExponentialBackOff} or calling
     ...
     */
    private CustomExponentialBackOff(Builder builder) {
    ...
    /**
     * Returns the elapsed time in milliseconds since an {@link CustomExponentialBackOff} instance is
     * created and is reset when {@link #reset()} is called.
     *
     * <p>
    ...
    /**
     * Builder for {@link CustomExponentialBackOff}.
     *
     * <p>
     * Implementation is not thread-safe.
     * </p>
    ...
    public static class Builder {
        ...
        /**
         * The maximum elapsed time in milliseconds after instantiating {@link CustomExponentialBackOff} or
        ...
        /** Builds a new instance of {@link CustomExponentialBackOff}. */
        public CustomExponentialBackOff build() {
            return new CustomExponentialBackOff(this);
        }
    }
}